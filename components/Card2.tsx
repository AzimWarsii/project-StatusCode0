  ...
  return (
    <div className="inline-block pl-3 pt-4 ">
      <a onClick={()=>setCheck(!check)}
        className={ check?`bg-green-500 block w-[212px] h-[187px] max-w-xs overflow-hidden shadow-md  transition-shadow duration-300 ease-in-out rounded-2xl  `:
        `block w-[212px] h-[187px] max-w-xs overflow-hidden shadow-md transition-shadow duration-300 ease-in-out rounded-2xl bg-white`}
      >
        ...
        <div className="pl-4 pt-4">
          ...
          <div className="flex font-thin text-xs font-inter text-black ">
            ...
            <div className="pt-3">7:00 am</div>
